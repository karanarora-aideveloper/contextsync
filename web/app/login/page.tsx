...
import { Brain, ArrowRight, Lock, Mail, AlertCircle, Sparkles, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center py-12 px-6 lg:px-8 text-slate-900 dark:text-slate-100 selection:bg-indigo-500 selection:text-white relative transition-colors duration-200">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-3">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Sign In to Your Memory Vault</h2>
        ...
        <div className="bg-white dark:bg-slate-900/70 py-8 px-6 shadow-xl dark:shadow-2xl rounded-3xl sm:px-10 border border-slate-200 dark:border-slate-800 backdrop-blur-md space-y-6">
          ...
          <div className="pt-2 border-t border-slate-200 dark:border-slate-800/80 text-center">
            <button
              ...
              className="text-xs text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 inline-flex items-center gap-1.5"
            >
