...
import { Brain, ArrowRight, Lock, Mail, AlertCircle, CheckCircle2 } from "lucide-react";
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-slate-900/70 py-8 px-6 shadow-2xl rounded-3xl sm:px-10 border border-slate-800 backdrop-blur-md space-y-6">
          ...
          <form className="space-y-4" onSubmit={handleSignup}>
            <div>
              <label className="block text-xs font-medium text-slate-300">Work or Personal Email</label>
            ...
            <div>
              <label className="block text-xs font-medium text-slate-300">Password (min. 6 characters)</label>
              <div className="mt-1.5 relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-500">
